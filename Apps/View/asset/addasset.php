			...
			<div class="jumbotron">
				...
				<form method="post" action="<?php echo $exe->url->create('default',['controller' => 'asset','action'=>'saveasset']);?>" class="form-horizontal">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<div class="checkbox">
								<label><input type="checkbox" name="status[]" value="development" required>Development</label>
							</div>
							<div class="checkbox">
								<label><input type="checkbox" name="status[]" value="got keys" required>Got the keys</label>
							</div>
							<div class="checkbox">
								<label><input type="checkbox" name="status[]" value="empty" required>Empty</label>
							</div>
							<div class="checkbox">
								<label><input type="checkbox" name="status[]" value="tenanted" required>Tenanted</label>
							</div>
							<div class="checkbox">
								<label><input type="checkbox" name="status[]" value="live" required>I live here</label>
							</div>
							<div class="checkbox">
								<label><input type="checkbox" id="sell" name="status[]" value="midst sell" required>Midst of selling</label>
							</div>
							<div class="checkbox">
								<label><input type="checkbox" id="buy" name="status[]" value="midst buy" required>Midst of buying</label>
							</div>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<div class="checkbox">
                                <label>
                                    <input type="checkbox" id="financeno" name="financing[]" value="no" required> No
                                </label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" id="financeyes" name="financing[]" value="yes" required> Yes
                                </label>
                            </div>
						</div>
					</div>
